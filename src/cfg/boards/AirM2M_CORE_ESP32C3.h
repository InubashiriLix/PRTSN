...
#define PRTN_BOARD_PIN_LIST(X)                                                                             \
    X(GPIO0, 0, ::prtn::pin::PinCap::Digital | ::prtn::pin::PinCap::Strapping)                             \
    X(GPIO1, 1, ::prtn::pin::PinCap::Digital)                                                              \
    X(GPIO2, 2, ::prtn::pin::PinCap::Digital)                                                              \
    X(GPIO3, 3, ::prtn::pin::PinCap::Digital)                                                              \
    X(GPIO4, 4, ::prtn::pin::PinCap::Digital | ::prtn::pin::PinCap::Analog)                                \
    X(GPIO5, 5, ::prtn::pin::PinCap::Digital)                                                              \
    X(GPIO6, 6, ::prtn::pin::PinCap::Digital)                                                              \
    X(GPIO7, 7, ::prtn::pin::PinCap::Digital)                                                              \
    X(GPIO8, 8, ::prtn::pin::PinCap::Digital)                                                              \
    X(GPIO9, 9, ::prtn::pin::PinCap::Digital | ::prtn::pin::PinCap::Boot | ::prtn::pin::PinCap::Strapping) \
    X(GPIO10, 10, ::prtn::pin::PinCap::Digital)                                                            \
...
#undef PRTN_NATIVE_GPIO
    ...
    namespace spi
    {
        inline constexpr gpio_num_t sck  = GPIO_NUM_2;
        inline constexpr gpio_num_t mosi = GPIO_NUM_3;
        inline constexpr gpio_num_t miso = GPIO_NUM_10;
        inline constexpr gpio_num_t cs   = GPIO_NUM_7;
    }

    namespace i2c0
    {
        inline constexpr gpio_num_t sda = GPIO_NUM_4;
        inline constexpr gpio_num_t scl = GPIO_NUM_5;
    }

    namespace uart0
    {
        inline constexpr gpio_num_t tx = GPIO_NUM_0;
        inline constexpr gpio_num_t rx = GPIO_NUM_1;
    }

    namespace rmt
    {
        inline constexpr gpio_num_t tx0 = GPIO_NUM_7;
    }
